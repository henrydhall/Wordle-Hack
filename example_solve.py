...
def actual_2022_04_28():
    ...
    my_list.search_right_letter_wrong_position('E',4)
    print(my_list.get_best_guess())
    my_list.search_right_letter_wrong_position('S',0)
    my_list.search_wrong_letter_wrong_position('L')
    my_list.search_right_letter_wrong_position('E',2)
    my_list.search_wrong_letter_wrong_position('P')
    my_list.search_right_letter_wrong_position('T',4)
    print(my_list.get_best_guess())
    my_list.search_wrong_letter_wrong_position('F')
    my_list.search_right_letter_right_position('E',1)
    my_list.search_right_letter_wrong_position('T',2)
    my_list.search_wrong_letter_wrong_position('U')
    my_list.search_right_letter_wrong_position('S',4)
    print(my_list.get_best_guess())
    my_list.print_narrowed_answers()

def actual_2022_04_30():
    my_list = WordList(answers_list,guesses_list)
    print(my_list.get_best_guess())
    my_list.search_wrong_letter_wrong_position('T')
    ...
    my_list.search_wrong_letter_wrong_position('E')
    print(my_list.get_best_guess())
    my_list.search_wrong_letter_wrong_position('M')
    my_list.search_wrong_letter_wrong_position('O')
    my_list.search_right_letter_right_position('R',2)
    my_list.search_right_letter_wrong_position('A',3)
    my_list.search_right_letter_wrong_position('L',4)
    print(my_list.get_best_guess())
    print('LARVA it is!')

def actual_2022_05_01():
    my_list = WordList(answers_list,guesses_list)
    print(my_list.get_best_guess())
    my_list.search_wrong_letter_wrong_position('T')
    my_list.search_right_letter_wrong_position('R',1)
    ...
    print(my_list.get_best_guess())
    my_list.search_right_letter_wrong_position('R',0)
    my_list.search_wrong_letter_wrong_position('H')
    my_list.search_wrong_letter_wrong_position('I')
    my_list.search_wrong_letter_wrong_position('N')
    my_list.search_right_letter_right_position('O',4)
    print(my_list.get_best_guess())
    print('It is FORGO!')
    my_list.print_narrowed_answers()
